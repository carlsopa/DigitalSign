...
function WeatherCall(lat,lon){
  ...
  .done(function(WeatherData){
    ...
    $('#WeatherWidget').append('<p>Current Temperature: <br>'+WeatherData.main.temp);
  })
...
function BusTable(bus){
  var $table = $('<table/>');
  $table.append("<th>Route ID</th><th>Direction</th><th>Minutes till arrival</th>");
  //$('#BusWidget').html(
